...
func (this *SSHSession) createConnection(user, password, ipPort string) error {
	...
	client, err := ssh.Dial("tcp", ipPort, &ssh.ClientConfig{
		...
		HostKeyAlgorithms: []string{ssh.KeyAlgoRSA, ssh.KeyAlgoDSA, ssh.KeyAlgoED25519},
		...
		Config: ssh.Config{
			...
			KeyExchanges: []string{
				"diffie-hellman-group1-sha1", "curve25519-sha256", "curve25519-sha256@libssh.org", "ecdh-sha2-nistp256",
				"ecdh-sha2-nistp384", "diffie-hellman-group14-sha256", "diffie-hellman-group14-sha1", "ext-info-c",
